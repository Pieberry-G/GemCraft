...
namespace GemCraft {
	...
	private:
		...
		std::shared_ptr<CGALMesh> m_CGALSubmesh;
		std::vector<CGALMesh::Vertex_index> m_SubmeshBoundary;

		UV_pmap m_SubmeshUVMap;
		std::vector<CGALPoint2> m_SubmeshUVBoundary;

		std::vector<float> m_GeodesicDistance;
